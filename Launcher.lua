...
EzLauncher.EzLauncher.Name = "LockHub"
...
EzLauncher.TextLabel.Text = "LOCK HUB Status"
...
EzLauncher.StatusName.Text = "LOCK Core"
...
EzLauncher.StatusName_2.Text = "LOCK API"
...
EzLauncher.StatusName_3.Text = "LOCK Hub"
...
EzLauncher.TextLabel_2.Text = "LOCK News"
...
EzLauncher.TextLabel_3.Text = "LOCK Hub"
...
EzLauncher.Launch.Text = "Launch LOCK"
...
local launcherData = game:GetService("HttpService"):JSONDecode(
	(game:HttpGet("https://raw.githubusercontent.com/Liveplayer19/Lock-Hub/refs/heads/main/LauncherData.json")));
